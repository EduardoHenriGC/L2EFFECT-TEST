...
public class TvT extends Event
{
	...
	private TvT()
	{
		...
		if ((calendar.get(Calendar.HOUR_OF_DAY) >= 20) && (calendar.get(Calendar.MINUTE) >= 51))
		{
		...
		ThreadPool.scheduleAtFixedRate(() -> eventStart(null), calendar.getTimeInMillis() - System.currentTimeMillis(), 1800000); // 86400000 = 1 day
	}
